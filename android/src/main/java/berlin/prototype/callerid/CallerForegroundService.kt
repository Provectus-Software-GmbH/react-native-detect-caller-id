        ...
        phoneStateReceiver = object : BroadcastReceiver() {
            override fun onReceive(context: Context, intent: Intent) {
              ...
              if (state == TelephonyManager.EXTRA_STATE_IDLE || state == TelephonyManager.EXTRA_STATE_OFFHOOK) {
                // Create missed call notification BEFORE clearing callServiceNumber
                CustomOverlayManager.createNotification(this@CallerForegroundService)
                CustomOverlayManager.dismissOverlay(this@CallerForegroundService)
                CustomOverlayManager.callServiceNumber = null
              }
            }
        }
